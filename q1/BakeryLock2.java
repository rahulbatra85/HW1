...
public class BakeryLock implements MyLock {
    ...
    private volatile boolean[] choosing; //NOT NEEDED -- private AtomicBoolean[] choosing; 
    ...
    public BakeryLock(int numThread) {
        ...
        //choosing = new AtomicBoolean[numThread]; //NOT NEEDED -- initialized to false by default 
    ...
    public void lock(int myId) {
        ...
        choosing[myId] = true; //choosing[myId].set(true);        
        for (int j=0; j<numThread; j++) {
        ...
        choosing[myId] = false; //NOT NEEDED -- choosing[myId].set(false); 
